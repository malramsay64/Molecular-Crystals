...
plots = [("order/*[0-9].png","Order Parameter"), ("trj_contact/*[0-9].png", "Configuration"), ("trj_contact/*-angles.png","Angle Distribution"), ("short_order.png", "Short Range Ordering"), ("msd.png", "Mean Squared Displacement"), ("rotation.png", "Rotational Relaxation"), ("histogram.png", "Contact Number"), ("props.png", "Properties"), ("short_order_hist.png", "Short Order Histogram"), ("radial.png", "Radial Distribution"), ("struct.png", "Structural Relaxation"), ("complot.png", "Centers of Mass"), ("moved.png", "Motion of Particles"), ("contact.log", "Data")]
